...
export namespace StartWatcherNotification {
   ...
   */
  export const type = new NotificationType<StartWatcherParams, void>('spotlight/startWatcher');
}
...
export namespace ValidateNotification {
   ...
   */
  export const type: NotificationType<TextDocument, void> = new NotificationType<TextDocument, void>('spotlight/validate');
}
