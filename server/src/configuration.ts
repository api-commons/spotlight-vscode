...
/**
 * Possible configuration values for when the Spotlight linter runs.
 */
...
export interface ExtensionSettings {
  /**
   * Controls whether or not Spotlight is enabled.
   */
  enable: boolean;
  ...
  /**
   * An array of file globs which should be validated by Spotlight. If language
  ...
  /**
   * An array of language IDs which should be validated by Spotlight. If file
